...
const Page = () => {
  const [fetchTime, setFetchTime] = useState(500);
  return (
    <div>
      <div className="flex justify-center items-center h-16">
        <ButtonB fetchTime={fetchTime} />
      </div>
      <div className="flex justify-center space-x-4 items-center h-16 ">
        <span className="text-xl">Fetch time: {fetchTime}ms</span>
        ...
        <input
          ...
          max="10000"
          value={fetchTime}
          onChange={(e) => setFetchTime(parseInt(e.target.value))}
        />
      </div>
